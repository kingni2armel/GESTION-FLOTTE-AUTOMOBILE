          ...
          <div class="row mb-2">
            <div class="col-sm-6">
                    @foreach ($infomarque as $infomarques)
                            <h1> Modification la marque {{$infomarques->nom}}</h1>
                                            ...
                                            <div class="bs-stepper-content">
                                                ...
                                                <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="nommarqueupdate" type="text" class="form-control" id="exampleInputEmail1" value="{{$infomarques->nom}}">
                                                    </div>
                                     
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Commentaire</label>
                                                        <textarea name="commentaireupdate" value="{{$infomarques->commentaire}}" class="form-control" id="" cols="30" rows="10"></textarea>
                                                    </div>
                                                    <div class="form-group">
