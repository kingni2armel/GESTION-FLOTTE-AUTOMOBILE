                  ...
                  <div class="bs-stepper-content">
                    ...
                    <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                      <div class="form-group">
                        ...
                        <input name="nomupdate" type="text" class="form-control" id="exampleInputEmail1" placeholder="Entrer  votre nom">
                      </div>
                      <div class="form-group">
                          <label for="exampleInputEmail1">Prenom</label>
                          <input name="prenomupdate" type="text" class="form-control" id="exampleInputEmail1" placeholder="Entrer  votre prenom">
                        </div>
                     
                      <div class="form-group">
                        <label for="exampleInputPassword1">Numero de telephone</label>
                        <input name="numeroupdate" type="number" class="form-control" id="exampleInputPassword1" placeholder="Entrer votre numero">
                      </div>
                    ...
                    <div id="information-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                      <div class="form-group">
                          ...
                          <input name="emailupdate" type="email" class="form-control" id="exampleInputEmail1" placeholder="Entrer  votre email">
                      </div>
                      <div class="form-group">
