...
<div class="content-wrapper" style="margin-right: 15px">
    <section class="content-header">
      ...
      <form action="{{route('CREATEVEDEPARTEMENT')}}"  method="post">
                  ...
                  <div class="bs-stepper-content">
                    ...
                    <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                        <div class="form-group">
                            ...
                            <input name="nomdepartement" type="text" class="form-control" id="exampleInputEmail1" placeholder="Entrer  le nom">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Nom Direction</label>
                            <select name="nomdirection" type="text" class="form-control" id="exampleInputEmail1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="commentairedepartement" class="form-control" id="" cols="30" rows="10"></textarea>
                        </div>
                        <div class="form-group">
