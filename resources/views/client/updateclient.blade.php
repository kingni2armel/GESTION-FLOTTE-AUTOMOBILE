@include('layout.header');
  ...
  @foreach ( $informationclient as $informationclients)
                          <form action="{{route('UPDATECLIENT',['id'=>$id=$informationclients->id])}}"  method="post">
                                      ...
                                      <div class="bs-stepper-content">
                                        ...
                                        <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                                          <div class="form-group">
                                            ...
                                            <input name="nomclientupdate" type="text" class="form-control" id="exampleInputEmail1" value="{{$informationclients->nom}}">
                                          </div>
                                          <div class="form-group">
                                              <label for="exampleInputEmail1">Prenom</label>
                                              <input name="prenomclientupdate" type="text" class="form-control" id="exampleInputEmail1" value="{{$informationclients->prenom}}">
                                            </div>
                                        
                                          <div class="form-group">
                                            <label for="exampleInputPassword1">Numero de telephone</label>
                                            <input name="numeroclientupdate" type="number" class="form-control" id="exampleInputPassword1" value="{{$informationclients->numero_telephone}}">
                                          </div>

                                          <div class="form-group">
                                            <label for="exampleInputEmail1">Email</label>
                                            <input name="emailclientupdate" type="email" class="form-control" id="exampleInputEmail1" value="{{$informationclients->email}}">
                                        </div>
